...
namespace std {
    ...
    template <typename char_type, typename size_type, size_type max_size, bool NulTerminate>
    struct hash<ant::basic_sstring<char_type, size_type, max_size, NulTerminate>> {
        size_t operator()(const ant::basic_sstring<char_type, size_type, max_size, NulTerminate>& s) const {
            return std::hash<ant::compat::basic_string_view<char_type>>()(s);
        }
    };

...
#include "ant/util/noncopyable_function.hh"
#include "ant/timer_set.hh"
...
public:
    ...
    timer(timer &&t) noexcept : _callback(std::move(t._callback)),
                                _expiry(std::move(t._expiry)),
                                _period(std::move(t._period)),
                                _armed(t._armed), _queued(t._queued),
                                _expired(t._expired) {
